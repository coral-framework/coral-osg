...
void Vec3_Adapter::add( coOsg::Vec3& instance, const coOsg::Vec3& other, coOsg::Vec3& result )
{
	result = instance + other;
}

void Vec3_Adapter::cross( coOsg::Vec3& instance, const coOsg::Vec3& other, coOsg::Vec3& result )
{
	result = instance ^ other;
}

void Vec3_Adapter::divScalar( coOsg::Vec3& instance, double scalar, coOsg::Vec3& result )
{
...
void Vec3_Adapter::multQuat( coOsg::Vec3& instance, const coOsg::Quat& quat, coOsg::Vec3& result )
{
	result = quat * instance;
}

void Vec3_Adapter::multScalar( coOsg::Vec3& instance, double scalar, coOsg::Vec3& result )
{
	result = instance * scalar;
}
...
void Vec3_Adapter::sub( coOsg::Vec3& instance, const coOsg::Vec3& other, coOsg::Vec3& result )
{
	result = instance - other;
}
